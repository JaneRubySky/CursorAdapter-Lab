...
/**
 * Created by janerubygrissom on 7/12/16.
 */

public class Shopper extends SQLiteOpenHelper {
    ...
    public static Shopper getInstance(Context context) {
        if (instance == null) {
            instance = new Shopper(context);
        }
        return instance;
    }

    private Shopper(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL(CREATE_EXAMPLE_LIST_TABLE);
